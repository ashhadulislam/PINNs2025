function ssr = F2(input_parameters)
global input_data
global data
global alpha
global E
...
%fitting
E=input_parameters(1); R=input_parameters(2); I=input_parameters(3); P0=input_parameters(4);
	if min([E R I P0])>1e-10 %Routh-Hurwitz criterion, a>0 represents a positive correlation between P and V'. set 1e-10 as 0 to avoid singular point
		%Simulation
		input=data(:,1)-P0;
		simin=[t2;input']';
