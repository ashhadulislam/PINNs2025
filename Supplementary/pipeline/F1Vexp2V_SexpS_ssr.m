function ssr = F1Vexp2V_SexpS_ssr(input_parameters)
global input_data
global x
global y
global E
...
disp(['x=',num2str(input_parameters(1)),' y=',num2str(input_parameters(2))])
x=input_parameters(1);
y=input_parameters(2);
[E R a b P0]=F1Vexp2V_SexpS(input_data,input_parameters(1),input_parameters(2));
b=abs(b);
